...
| ------------------------------------ | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| [not-my-gemini] Preferred Language   | `general.preferredLanguage`        | The preferred natural language for the AI to respond in.                                                                                                                                                                                                      | `undefined` |
| [not-my-gemini] Enable Notifications | `general.enableNotifications`      | Enable notifications for action-required prompts and session completion. Supported on Windows and macOS.                                                                                                                                                      | `true`      |
| [not-my-gemini] Parallel Retry Count | `general.parallelRetryCount`       | Number of parallel requests to send when encountering 429 High Demand errors (0 to disable).                                                                                                                                                                  | `3`         |
...
| [not-my-gemini] Retry Fetch Errors   | `general.retryFetchErrors`         | Retry on "exception TypeError: fetch failed sending request" errors.                                                                                                                                                                                          | `true`      |
